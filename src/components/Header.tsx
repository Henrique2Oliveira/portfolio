...
function Header() {
  return (
    <header className="flex flex-col bg-midnight text-lightp-4 md:p-8 justify-center items-center gap-y-2">
      ...
      <button className="rounded-full bg-white hover:bg-[#a8a8a8] hover:text-white w-fit text-black px-5 py-2 shadow-[-1px_6px_0px_0px_rgba(0,_0,_0,_0.9)] hover:px-6 transition-all duration-100 ease-in "><a href="#" >Contact me</a></button>
